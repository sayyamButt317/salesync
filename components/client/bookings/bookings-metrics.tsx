...
import type { BookingMetric } from "@/lib/client-bookings/types";
import { MetricCard } from "@/components/ui/metric-card";
import { useGsapStaggerGrid } from "@/lib/motion/use-gsap-stagger-grid";

export interface BookingsMetricsProps {
  metrics: BookingMetric[];
}

export function BookingsMetrics({ metrics }: BookingsMetricsProps) {
